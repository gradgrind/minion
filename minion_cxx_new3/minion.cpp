...
MValue MValue::copy()
{
    switch (type) {
    case T_String:
        return {T_String, new MString(*reinterpret_cast<MString*>(minion_item))};
    case T_Array: {
